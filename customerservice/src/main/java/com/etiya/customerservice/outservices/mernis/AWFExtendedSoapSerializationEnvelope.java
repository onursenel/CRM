...
class AWFSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class AWFExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(AWFDateTimeConverter converter)
    {
        if(converter==null)
        {
            converter = new AWFStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static AWFDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static AWFDateTimeConverter dateTimeConverter = new AWFStandardDateTimeConverter();

    public AWFExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public AWFExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new AWFMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=AWFHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,AWFExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=AWFHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
