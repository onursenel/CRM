...
public class AWFKPSPublicSoap
{
    ...
    public AWFKPSPublicSoap(){}

    public AWFKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public AWFKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        AWFExtendedSoapSerializationEnvelope envelope= new AWFExtendedSoapSerializationEnvelope(AWFExtendedSoapSerializationEnvelope.VER11);
